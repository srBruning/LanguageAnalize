...
public class Token {
	...
	public static enum TypeToken{CONST_NUM, NONE, 
		...
		TK_SUBIGUAL,TK_MULTP,TK_MULTPIGUAL,TK_DIVIGUAL,TK_VIRG,TK_AND,TK_OR, NULL,VAR,AUTO,BREAK,CASE,CHAR,CONST,CONTINUE,DEFAULT,DO,INT,LONG,REGISTER,RETURN,SHORT,SIGNED,
